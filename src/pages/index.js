...
const IndexPage = () => {
  return (
    <Layout className={css.root}>
      ...
      <div className={classnames(grid.container, grid.grid)}>
        <div className={css.text} id="about">
          ...
          <p>
            ...
            dance, photography, painting, etc. A focus of the Processing project
            is to make learning how to program and make creative work with code
            accessible to diverse communities, especially those who might not
            otherwise have access to these tools and resources.
          </p>
        </div>
        <div className={css.text} id="open-call">
          <h2>Open Call</h2>
          <p>
        ...
        <div className={css.text} id="contact">
          <h2>Contact</h2>
          <p>
